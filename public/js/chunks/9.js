...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getEditar: function getEditar(idtipo_contenido) {
      this.$router.push('/home/tipo_contenido/editar/' + idtipo_contenido);
      console.log(idtipo_contenido);
    },
    getEliminar: function getEliminar(idtipo_contenido) {
      var me = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.delete("http://localhost:8000/api/tipo/" + idtipo_contenido).then(function (response) {
        me.getArea();
      }).catch(function (error) {});
    }
  }
                        ...
                        _c(
                          ...
                          [
                            _c("vs-button", {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.getEditar(tr.idtipo_contenido)
                                }
                              }
                            }),
                            _vm._v(" "),
                            _c("vs-button", {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.getEliminar(tr.idtipo_contenido)
                                }
                              }
                            })
                          ],
