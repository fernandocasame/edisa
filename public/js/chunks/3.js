...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getDocente: function getDocente(idusuario) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("https://sistemaeducativo.edisa.ec/api/estudiante/" + idusuario).then(function (response) {
        console.log(response.data);
    ...
    guardar: function guardar(data) {
      ...
      console.log(data);
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("https://sistemaeducativo.edisa.ec/api/estudiante", data).then(function (response) {
