...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getContenido: function getContenido() {
      var me = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://localhost:8000/api/tcontenido', {}).then(function (response) {
    ...
    getEliminar: function getEliminar(idtipo) {
      var me = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.delete('http://localhost:8000/api/tcontenido/' + idtipo).then(function (response) {
        me.getContenido();
      }).catch(function (error) {});
    }
  }
