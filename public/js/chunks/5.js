...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getArea: function getArea() {
      var me = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://69.64.46.74:8000/api/area', {}).then(function (response) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass: "mr-4",
          attrs: { type: "border", color: "success", to: "/home/areas/nueva" }
        },
        [_vm._v("Nueva Area")]
      ),
      _vm._v(" "),
