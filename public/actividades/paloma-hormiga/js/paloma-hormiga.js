var cont = 1,
    ...
    function f_pregunta2() {
        itemsC = 5;
        var pregs = ['<div class="form-group row p-2"> <div class="col-sm-2 col-xs-4"> <select class="form-control accion0 combo-opciones"> <option value="">Seleccione</option> </select> </div> <div class="col-sm-10 col-xs-8"> Las hormigas son capaces de llevar bastante peso sobre sus espaldas, cuando caminan hacia su <b>hogar.</b> </div> </div>', '<div class="form-group row p-2"> <div class="col-sm-2 col-xs-4"> <select class="form-control accion1 combo-opciones"> <option value="">Seleccione</option> </select> </div> <div class="col-sm-10 col-xs-8"> Cuando una persona se esconde, <b>tiene la idea</b> de no dejarse ver por los demás. </div> </div>', '<div class="form-group row p-2"> <div class="col-sm-2 col-xs-4"> <select class="form-control accion2 combo-opciones"> <option value="">Seleccione</option> </select> </div> <div class="col-sm-10 col-xs-8"> Vinces es una ciudad ubicada cerca del <b>límite entre la tierra y el río</b> Vinces. </div> </div>', '<div class="form-group row p-2"> <div class="col-sm-2 col-xs-4"> <select class="form-control accion3 combo-opciones"> <option value="">Seleccione</option> </select> </div> <div class="col-sm-10 col-xs-8"> Los cazadores usan un <b>arma de fuego con cañones largos.</b> </div> </div>', '<div class="form-group row p-2"> <div class="col-sm-2 col-xs-4"> <select class="form-control accion4 combo-opciones"> <option value="">Seleccione</option> </select> </div> <div class="col-sm-10 col-xs-8"> Algunos pájaros dan <b>pequeñas vueltas</b> sobre los árboles de fruta madura. </div> </div>'];
    ...
    function f_pregunta4() {
        var words = ['TOMANDO', 'PREDECIR', 'PERSEGUIR', 'IRA', 'DENTELLADA','COMPAÑERA'];
